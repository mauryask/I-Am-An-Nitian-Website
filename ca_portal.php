...
$('#dash').click(function(){
  ...
  $('.t2,.t3,.t4,.t5').fadeOut(1000).css('display', 'none');

  $('.t1').fadeIn(1000);
  $('.card').css('display', 'flex'); 
  $('.cardx,.tasks,.cardy,.msgx').css('display', 'none');

//button control
  $('#contact,#post,#task,#guide').css({'background':'none', 'color':'#050505'});
...
$('#post').click(function(){
  $(this).css({'background': '#282828', 'color':'white'});
  $('.t1,.t3,.t4,.t5').fadeOut(1000).css('display', 'none');
  $('.t2').fadeIn(1000).css('display', 'block');
  
  $('.card,.tasks').css('display', 'none');
...
//button control
$('#contact,#dash,#task,#guide').css({'background':'none', 'color':'#050505'});
...
$('#task').click(function(){
  $(this).css({'background': '#282828', 'color':'white'});
  $('.t1,.t2,.t4,.t5').fadeOut(1000).css('display', 'none');

  $('.t3').fadeIn(1000).css('display', 'block');
  $('.card,.cardy').fadeOut(1000).css('display', 'none');
  $('.tasks').fadeIn(1000).css('display', 'flex');
  $('.msgx').css('display', 'none');


//button control
$('#contact,#dash,#post,#guide').css({'background':'none', 'color':'#050505'});
...
$('#guide').click(function(){
  $(this).css({'background': '#282828', 'color':'white'});
  $('.t1,.t2,.t3,.t5').fadeOut(1000).css('display', 'none');


  $('.t4').fadeIn(1000).css('display', 'block');
  $('.card,.cardx').fadeOut(1000).css('display', 'none');
  $('.msgx').css('display', 'none');

  $('#contact,#dash,#post,#task').css({'background':'none', 'color':'#050505'});
...
$('#contact').click(function(){
  $(this).css({'background': '#282828', 'color':'white'});
  $('.t1,.t2,.t3,.t4').fadeOut(1000).css('display', 'none');

  $('.t5').fadeIn(1000).css('display', 'block');
  $('.card,.tasks , .cardx').css('display', 'none');
  $('.cardy').css('display', 'block');
  $('.msgx').css('display', 'none');

  $('#dash,#post,#task,#guide').css({'background':'none', 'color':'#050505'});
 })
